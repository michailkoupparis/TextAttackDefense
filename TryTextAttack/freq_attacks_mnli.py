...
class FrequencySearchMNLI(SearchMethod):
...
class FrequencyR(AttackRecipe):
    ...
    def build(model):
        ...
        transformations = [WordSwapEmbedding(max_candidates=7),WordSwapWordNet()]
        ...
        #
        search_method = FrequencySearchMNLI('R')
...
class FrequencyP(AttackRecipe):
    ...
    def build(model):
        ...
        # Greedily swap words with "Word Importance Ranking".
        #
        search_method = FrequencySearchMNLI('P')
