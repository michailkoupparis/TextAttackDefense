...
def get_nli(data_path):
    ...
    for data_type in ['train', 'dev_matched', 'dev_mismatched']:
    ...
    dev = {'s1': s1['dev_matched']['sent'], 's2': s2['dev_matched']['sent'],
           'label': target['dev_matched']['data']}
    test = {'s1': s1['dev_mismatched']['sent'], 's2': s2['dev_mismatched']['sent'],
            'label': target['dev_mismatched']['data']}
